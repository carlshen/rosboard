...
class InfraFile(BaseModel):
    ...
    size = peewee.BigIntegerField(default=0, verbose_name='size', help_text='文件大小')
    status = peewee.IntegerField(default=0, verbose_name='status', help_text='文件状态')
    task_id = peewee.BigIntegerField(default=0, verbose_name='task_id', help_text='当前任务ID')
...
class DeviceList(BaseModel):
    ...
    device_x = peewee.DoubleField(default=0.0, verbose_name='device_x', help_text='设备X坐标')
    device_y = peewee.DoubleField(default=0.0, verbose_name='device_y', help_text='设备Y坐标')
    device_z = peewee.DoubleField(default=0.0, verbose_name='device_z', help_text='设备Z坐标')
    device_roll = peewee.DoubleField(default=0.0, verbose_name='device_roll', help_text='节点旋转角度Roll')
    device_pitch = peewee.DoubleField(default=0.0, verbose_name='device_pitch', help_text='节点旋转角度Pitch')
    device_yaw = peewee.DoubleField(default=0.0, verbose_name='device_yaw', help_text='节点旋转角度Yaw')
    device_qx = peewee.DoubleField(default=0.0, verbose_name='device_qx', help_text='四元数姿态qx')
    device_qy = peewee.DoubleField(default=0.0, verbose_name='device_qy', help_text='四元数姿态qy')
    device_qz = peewee.DoubleField(default=0.0, verbose_name='device_qz', help_text='四元数姿态qz')
    device_qw = peewee.DoubleField(default=0.0, verbose_name='device_qw', help_text='四元数姿态qw')
    task_id = peewee.BigIntegerField(default=0, verbose_name='task_id', help_text='当前任务ID')
    user_id = peewee.TextField(default='', verbose_name='user_id', help_text='用户id')
