...
class DeviceList(BaseModel):
    ...
    task_interrupt = peewee.BigIntegerField(default=0, verbose_name='task_interrupt', help_text='中断任务ID')
    node_interrupt = peewee.BigIntegerField(default=0, verbose_name='node_interrupt', help_text='中断节点ID')
    task_id = peewee.BigIntegerField(default=0, verbose_name='task_id', help_text='当前任务ID')
    node_id = peewee.BigIntegerField(default=0, verbose_name='node_id', help_text='当前节点ID')
    user_id = peewee.TextField(default='', verbose_name='user_id', help_text='用户id')
